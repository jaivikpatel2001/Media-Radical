...
export const industries: Industry[] = [
  {
    ...
    caseStudySlugs: ['northwind-capital-platform'],
  ...
  },
  {
    ...
    summary:
      'Online stores that stay fast on Black Friday and keep stock counts accurate afterwards.',
    icon: 'retail',
    accent: 'violet',
    challenges: [
      'The site cannot be touched during the busy season',
